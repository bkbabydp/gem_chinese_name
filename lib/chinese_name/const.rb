module ChineseName
  FAMILY_NAME = LAST_NAME = ['赵 钱 孙 李 周 吴 郑 王 冯 陈 褚 卫',
                             ...
                             '公良 段干 开 光 操 瑞 眭 泥 运 摩 伟 铁 迮 禅 鬼 死'].freeze

  GIVEN_NAME = FIRST_NAME = ['1 一 土：克父伤母，性刚果断，少年艰难，中年劳，晚年吉祥。',
                             ...
                             '27 骧 火：多才贤能，温和贤淑，忌车怕水，少年艰难，中年劳，晚年吉祥。'].freeze
end
